...
public class GawdScape {
	...
	public GawdScape(String id, Date updateTime, String minecraftVersion, String mainClass, String minecraftArguments) {
	...
	public GawdScape(GawdScape version) {
		this(version.getId(), version.getUpdatedTime(), version.getMinecraftVersion(), version.getMainClass(), version.getMinecraftArguments());
